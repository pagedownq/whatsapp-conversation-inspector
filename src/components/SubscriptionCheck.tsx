    ...
    return (
      <>
        ...
        >
          ...
          <h2 className="text-xl font-semibold mb-2">Premium Abonelik Gerekli</h2>
          <p className="text-muted-foreground mb-6">
            Bu özelliği kullanmak için premium aboneliğe sahip olmanız gerekmektedir.
          </p>
          <Button onClick={() => setShowDialog(true)}>Abonelik Al</Button>
        </motion.div>
        
        <Dialog open={showDialog} onOpenChange={setShowDialog}>
          <DialogContent>
            <DialogHeader>
              <DialogTitle>Premium Abonelik</DialogTitle>
              <DialogDescription>
            ...
            <div className="py-4">
              <div className="border rounded-lg p-4 mb-4">
                <h3 className="font-medium mb-2">Premium Özellikleri:</h3>
