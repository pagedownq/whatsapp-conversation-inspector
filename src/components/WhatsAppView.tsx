        ...
        {Object.entries(messagesByDate).map(([date, msgs]) => (
          <div key={date} className="mb-4">
            ...
            {msgs.map((message, idx) => {
              const { bgColor, textColor } = getMessageStyle(message.sender, message.isMedia);
